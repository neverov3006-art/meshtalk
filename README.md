...
Маскировка иконки приложения под системный процесс/скрытие факта использования
мессенджера — не входит в этот проект (подробности обсуждались в чате). Вместо
этого доступны обычные приватность-функции: скрытие текста сообщений в уведомлениях,
PIN-код на вход в приложение — их можно добавить отдельным шагом, если нужно.
